    ...
    <>
      ...
      <main style={{ background: '#f7f8fa', minHeight: '70vh', padding: '2rem 0' }}>
        <div style={{ maxWidth: 1500, margin: '0 auto', display: 'flex', gap: '2.5rem' }}>
          <ShopSidebar active="details" shopId={shopId} />
          <div style={{ flex: 1 }}>
            <div style={{ maxWidth: 900, margin: '0 auto', background: '#fff', borderRadius: 16, boxShadow: '0 2px 16px rgba(44,204,113,0.07)', padding: '2.5rem 2rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 32, marginBottom: 24 }}>
                ...
                <div>
                  <div style={{ fontSize: 28, fontWeight: 800, color: '#1b5e20', marginBottom: 6 }}>{shop.ShopName || 'Shop Name'}</div>
